...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  'hero.title1': { en: 'Twenty-three tools that', tr: 'Yirmi üç araç —', de: 'Dreiundzwanzig Tools, die' },
  ...
  'tools.head': { en: 'Browse the suite', tr: 'Takımı keşfet', de: 'Die Suite durchstöbern' },
  'bb.kicker': { en: 'Featured', tr: 'Öne çıkan', de: 'Empfohlen' },
  'bb.spotlight': { en: 'Spotlight', tr: 'Vitrin', de: 'Im Rampenlicht' },
  ...
  'cat.all': { en: 'All 23', tr: 'Hepsi 23', de: 'Alle 23' },
  ...
  'cat.agents': { en: '🤖 Agents', tr: '🤖 Ajanlar', de: '🤖 Agenten' },
  'cat.intelligence': { en: '📡 Intelligence', tr: '📡 İstihbarat', de: '📡 Intelligenz' },
  'cat.games': { en: '🕹️ Games', tr: '🕹️ Oyunlar', de: '🕹️ Spiele' },
...
const TAGLINES: Record<string, Partial<Record<Lang, string>>> = {
  ...
  pdfstudio: { tr: 'PDF\'inizin içindeki metni düzenleyin — özel, ücretsiz, açık kaynak', de: 'Bearbeiten Sie den Text in Ihrer PDF — privat, kostenlos, Open Source' },
  designhealth: { tr: 'HTML için 18 belirleyici tasarım kalitesi kontrolü — LLM yok, API anahtarı yok', de: '18 deterministische Design-Qualitätsprüfungen für HTML — kein LLM, kein API-Key' },
  skillslice: { tr: 'Doğrulanmış tek bir beceri klasörünü kopyalayın — bir dilim, pasta değil', de: 'Einen Read-verifizierten Skill-Ordner kopieren — ein Stück, nicht der ganze Kuchen' },
  liecatchers: { tr: 'Ajanınız “Bitti” dedi. Kanıtlayın — on sensör, tek RECEIPT.json', de: 'Ihr Agent sagte „Fertig“. Beweisen Sie es — zehn Sensoren, eine RECEIPT.json' },
  bookguide: { tr: 'Kitaplarınızla teslimat yapın — ajanlar alıntı yapar, playbook çalıştırır, öğrenir', de: 'Mit Ihren Büchern liefern — Agenten zitieren, führen Playbooks aus, lernen' },
  datainsights: { tr: 'Kurucu istihbaratı — günlük ve haftalık teknoloji sinyal bültenleri', de: 'Founder-Intelligenz — tägliche & wöchentliche Tech-Signal-Briefings' },
  ironaxe: { tr: 'Özgün bir yandan kaydırmalı beat \'em up — Godot 4', de: 'Ein originales Side-Scrolling-Beat-\'em-up — Godot 4' },
