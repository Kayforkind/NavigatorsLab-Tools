...
const CATALOG = [
  ...
  { id: 'pdfstudio', name: 'PDF Studio', url: 'https://navigatorslab.com/', agent_params: '— (open the app; CLI n/a)', files: 'pdf', what: 'edit text inside PDFs, fill forms, OCR scans, sign, redact, organize pages, diff revisions, on-device AI', repo: 'https://github.com/Kayforkind/NavigatorsLab-PDF-Studio' },
  ...
  { id: 'liecatchers', name: 'liecatchers', url: 'https://github.com/Kayforkind/liecatchers', agent_params: '— (uvx --from . liecatcher run)', files: 'workspace', what: 'verify an agent\'s “Done” — ten sensors, one signed RECEIPT.json, zero API keys', repo: 'https://github.com/Kayforkind/liecatchers' },
  { id: 'bookguide', name: 'Book Guide MCP', url: 'https://github.com/Kayforkind/book-guide-mcp', agent_params: '— (MCP stdio server)', files: 'books', what: 'agent-callable books: cite with locators, run playbooks, Socratic & Avicenna tutors; local-first, no API keys', repo: 'https://github.com/Kayforkind/book-guide-mcp' },
  { id: 'datainsights', name: 'Data Insights', url: 'https://github.com/Kayforkind/data-insights', agent_params: '— (npm run dev)', files: '—', what: 'founder intelligence — daily 5W1H report, weekly synthesis, headline river, JSON APIs for agents', repo: 'https://github.com/Kayforkind/data-insights' },
  { id: 'ironaxe', name: 'Iron Axe: Legacy', url: 'https://github.com/Kayforkind/iron-axe-legacy', agent_params: '— (Godot 4)', files: '—', what: 'original side-scrolling beat \'em up in Godot 4 — original characters, story and assets', repo: 'https://github.com/Kayforkind/iron-axe-legacy' },
];
