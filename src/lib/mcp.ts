...
const CATALOG = [
  { id: 'exif', name: 'Photo Privacy Kit', url: 'https://navigatorslab.com/tools/exif.html', agent_params: '?url=<file-url>', files: 'jpg, jpeg, png, webp, heic*', what: 'strip GPS/camera/timestamp EXIF, show SHA-256 before/after' },
  { id: 'metadata', name: 'Metadata & Hidden-Data Checker', url: 'https://navigatorslab.com/tools/metadata.html', agent_params: '?url=<file-url>', files: 'jpg, png, pdf, docx, xlsx, pptx', what: 'inspect + strip hidden metadata' },
  { id: 'shrink', name: 'Image Shrinker', url: 'https://navigatorslab.com/tools/shrink.html', agent_params: '?url=<image-url>&format=webp&targetKB=300', files: 'jpg, png, webp', what: 'binary-search quality to hit an exact KB target; AVIF supported via UI' },
  { id: 'scan', name: 'Scan & Screenshot Cleaner', url: 'https://navigatorslab.com/tools/scan.html', agent_params: '?url=<image-url>', files: 'jpg, png', what: 'auto-straighten, auto-levels, threshold, crop → clean PDF' },
  { id: 'sign', name: 'Local E-Sign Pad', url: 'https://navigatorslab.com/tools/sign.html', agent_params: '?url=<pdf-url>&date=1', files: 'pdf', what: 'draw/type a signature, place it, optional date stamp, flatten' },
  { id: 'receipts', name: 'Receipts → One PDF', url: 'https://navigatorslab.com/tools/receipts.html', agent_params: '?url=<image-url>', files: 'jpg, png', what: 'EXIF date-sorted receipt book PDF' },
  { id: 'ocr', name: 'Receipt OCR → CSV', url: 'https://navigatorslab.com/tools/ocr.html', agent_params: '?url=<image-url>&autostart=1', files: 'jpg, png', what: 'on-device Tesseract OCR of receipt totals → CSV' },
  { id: 'qr', name: 'QR Studio', url: 'https://navigatorslab.com/tools/qr.html', agent_params: '?text=<payload>', files: '—', what: 'generate PNG/SVG or decode any QR image locally' },
  { id: 'audio', name: 'Audio Trimmer', url: 'https://navigatorslab.com/tools/audio.html', agent_params: '?url=<audio-url>', files: 'wav, mp3, m4a, ogg', what: 'trim on the waveform, fades, normalize, WAV/MP3 out' },
  { id: 'invoice', name: 'Invoice / Quote Generator', url: 'https://navigatorslab.com/tools/invoice.html', agent_params: '— (UI-driven)', files: '—', what: 'line items → PDF invoice, live preview' },
  { id: 'rename', name: 'Batch Rename & Sort', url: 'https://navigatorslab.com/tools/rename.html', agent_params: '?url=<image-url>&prefix=receipt-&suffix=&start=1', files: 'jpg, png (zip ok)', what: 'EXIF-dated renaming, prefix/suffix/sequence, zip out' },
  { id: 'printprep', name: 'Print-Shop Prep', url: 'https://navigatorslab.com/tools/printprep.html', agent_params: '?url=<image-url>&size=4x6', files: 'jpg, png', what: 'exact print sizes, bleed, 300 DPI checks, PDF out' },
  { id: 'pdfpages', name: 'PDF Pages', url: 'https://navigatorslab.com/tools/pdfpages.html', agent_params: '?url=<pdf-url>', files: 'pdf', what: 'reorder/rotate/delete/extract/blank/merge pages' },
  { id: 'textdiff', name: 'Text Diff', url: 'https://navigatorslab.com/tools/textdiff.html', agent_params: '?a=<text-url>&b=<text-url>', files: 'any text', what: 'line diff, word-level highlights, similarity %, unified diff' },
  { id: 'textstats', name: 'Text Stats', url: 'https://navigatorslab.com/tools/textstats.html', agent_params: '?url=<text-url>', files: 'any text', what: 'counts, reading time, Flesch, keyword density, rhythm' },
];
